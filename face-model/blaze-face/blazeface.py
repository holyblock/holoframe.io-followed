# adopted from https://github.com/hollance/BlazeFace-PyTorch/blob/master/blazeface.py
  ...
  def _decode_boxes(self, raw_boxes, anchors):
    ...
    for k in range(6):
      ...
      keypoint_x = raw_boxes[...,
                             offset] / self.x_scale * anchors[:, 2] + anchors[:,
                                                                              0]
      keypoint_y = raw_boxes[..., offset +
                             1] / self.y_scale * anchors[:, 3] + anchors[:, 1]
